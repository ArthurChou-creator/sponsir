import { API_BASE_URL, CART_ITEM_STATUS, MEETING_STATUS } from "../utils/constants";
...
export const getCartItems = async (sponsorId) => {
  try {
    // Simulate API call
    await delay(400);
...
// Add item to cart
export const addToCart = async (sponsorId, sponsorshipPlanId) => {
  try {
    // Simulate API call
    await delay(500);
...
export const checkout = async (sponsorId, paymentDetails) => {
  try {
...
export const getSponsorships = async (sponsorId) => {
  try {
    // Simulate API call
    await delay(400);
...
// Schedule a meeting
export const scheduleMeeting = async (sponsorId, organizerId, eventId, meetingData) => {
  try {
    // Simulate API call
    await delay(600);
...
export const getSponsorMeetings = async (sponsorId) => {
  try {
    // Simulate API call
    await delay(500);
...
export const getOrganizerMeetings = async (organizerId) => {
  try {
    // Simulate API call
    await delay(500);
...
export const confirmMeeting = async (meetingId, confirmedTime, meetingLink) => {
  try {
    // Simulate API call
    await delay(400);
...
export const getSponsoredEvents = async (sponsorId) => {
  try {
    // Simulate API call
    await delay(600);
    
    // Get confirmed sponsorships
    const sponsorships = await getSponsorships(sponsorId);
    
    // This would typically involve fetching the associated events
    // For this mock, we'll just return an empty array
    
    return [];
  } catch (error) {
    console.error(`Error getting sponsored events for sponsor ID ${sponsorId}:`, error);
    throw error;
  }
};